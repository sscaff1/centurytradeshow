...
if (Services.find().count() === 0) {
  var services = [
    ...
    {name:"executive protection",description:"Century understands the extensive planning and flawless execution necessary to protect a dignitary, celebrity, or other high-profile persons without smothering or drawing attention to the client. We also offer a selection of transportation vehicles for you to choose from.",type:"security",img:"/img/s_exec_protection.jpg"},
    ...
    {name:"overtime",description:"Century Event Staffing complies with all labors laws in the cities and states in which we operate. We schedule the same staff through the entire event; therefore, they only need to be trained once and are familiar with the expectation and the event itself.",type:"staffing",img:"/img/DSC_0113.JPG"},
