if (Employees.find().count() === 0) {
  var employees = [
    ...
    {name:"Kristine Parentela",title:"Schedule Coordinator",email:"kparentela@centurytradeshow.com",company:"vegas"},
...
if (Services.find().count() === 0) {
  var services = [
    {name:"qualifications",description:"Consulting team, full building security, booth security, armed security, executive protection, and video surveillance.",type:"security",img:"/img/DSC_0202.JPG"},
    {name:"licensing",description:"Century Security & Event Staffing, Inc. complies with all security licensing requirements stipulated by the state. These licenses are monitored and checked before every event. Century only hires individuals who have met all of the fundamental requirements, as well as our own interview criteria.",type:"security", img:"/img/s_license.jpg"},
    {name:"communications",description:"Century owns 240 Motorola HT1250-LS radios that we use for on-site communication. All of our show-site supervisory personnel are also equipped with Nextel radios to communicate with our staff, show management, and other contractors.",type:"security",img:"/img/s_radio.jpg"},
    {name:"video surveillance",description:"Century owns 45 portable video surveillance systems, with 280 individual cameras. The cameras transfer video over Ethernet and are powered from that single Ethernet line. These units are self-contained, and include one DVR with a 24 hour recording cycle and 1 terabyte of memory. The systems are internet capable for remote monitoring.",type:"security",img:"/img/DSC_0138.JPG"},
    {name:"consulting",description:"Century travels with many different events every year. These events are held in almost every popular tradeshow destination, so our management team is familiar with nearly all major convention centers in the country! Century provides on-site management to handle and oversee all security needs of the event so that you don’t have to worry about a thing.",type:"security",img:"/img/s_security_guard.jpg"},
    {name:"security specialists",description:"We know some events/areas are more important than others. As an alternative to standard security guards, Century offers personnel that have previous law enforcement experience and training. Century Security uses security specialists in these key areas to ensure that your event runs smoothly. This service distinguishes us from other providers.",type:"security",img:"/img/DSC_0051.JPG"},
    {name:"executive protection",description:"Century understands the extensive planning and flawless execution necessary to protect a dignitary, celebrity, or other high-profile persons without smothering or drawing attention to the client. We also offer a selection of transportation vehicles for you to choose from.",type:"security",img:"/img/s_law_enforcement_2.jpg"},
    {name:"camera patrol",description:"Many events are private, industry exclusive events attended by those with invitations only. Century offers a camera patrol service to eliminate any worry about any unauthorized photography or video footage during your event.",type:"security",img:"/img/DSC_0061.JPG"},
    {name:"uniforms",description:"All Century Security Staff are professionally uniformed. Our uniforms consist of a black blazer with a Century Security emblem, a white security shirt, a black tie, black pants, and a Century issued ID badge.",type:"security",img:"/img/s_uniforms.jpg"},
    {name:"qualifications",description:"Century Staff services include but are are not limited to: registration assistants, lead retrieval, typists, badge pullers, information desk personnel, ticket takers, room/session monitors, show office managers, hosts & hostesses, show floor runners, floor manager assistants, directional staff, bilingual staff, and fulfillment staff.",type:"staffing",img:"/img/s_reg_assistants.jpg"},
    {name:"uniform",description:"Century offers a variety of uniform / dress options. Century staff can be easily identified dressed in our yellow polo with company logo, black slacks, lanyards and photo ID name badge. For a more formal look, staff can wear maroon blazers with white button down shirts and black slacks. Our conference assistants can also be dressed in business professional, business casual, or your conference attire.",type:"staffing",img:"/img/DSC_0124.JPG"},
    {name:"overtime",description:"Century Event Staffing complies with all labors laws in the cities and states in which we operate. We schedule the same staff through the entire event; therefore, they only need to be trained once and are familiar with the expectation and the event itself.",type:"staffing",img:"/img/DSC_0161.JPG"},
    {name:"registration assistants",description:"Registration is often the first line of contact an attendee has with your event on-site. Our event registration staff is computer knowledgeable and customer service oriented, ready to make a positive impact on each attendee with a great attitude and a smile!",type:"staffing",img:"/img/IMG_1785.JPG"},
    {name:"room/session monitors",description:"Our room/session monitors will keep your sessions running smoothly. Room monitors are trained to assist with distributing meeting materials, taking a head-count, ensuring that attendees are at the correct sessions and any other duties you may require.",type:"staffing",img:"/img/DSC_0200.JPG"},
    {name:"directional/information desk staff",description:"Our knowledgeable staff will assist your attendees with general event and venue information, as well as offering guidance on local attractions and dining options.",type:"staffing",img:"/img/Staffing Uniform.jpg"},
    {name:"fulfillment",description:"Century has experienced staff for your fulfillment needs. For instance, let Century take the shipping logistics off your hands… We will be happy to receive your shipments at our warehouse for advance fulfillment and deliver completed materials to show site.",type:"staffing",img:"/img/DSC_0078.JPG"},
    {name:"press/speaker room assistants",description:"Speakers and media attendees are integral to the success of your event. Our staff will provide a high level of professional customer service to these VIPs, assisting them by answering phones, taking messages, operating basic office equipment, and providing event information and directions as needed.",type:"staffing",img:"/img/s_staffing.jpg"},
    {name:"booth host/hostess/model",description:"Let us help increase traffic to your booth! Our booth assistants are experienced in providing customer service to attendees that come into your booth by greeting them, collecting business cards, handing out promotional materials, etc.",type:"staffing",img:"/img/s_directional_staff.jpg"},
  ]
